    ...
    */
    ...
    'options' => [
        ...
        'font_family' => [
            ...
            // ฟอนต์ภาษาไทย
            'THSarabunNew' => [
                'normal'      => public_path('fonts/THSarabunNew.ttf'),
                'bold'        => public_path('fonts/THSarabunNew Bold.ttf'),
                'italic'      => public_path('fonts/THSarabunNew Italic.ttf'),
                'bold_italic' => public_path('fonts/THSarabunNew BoldItalic.ttf'),
            ],
        ],
